...
impl Solver {
    ...
    /// **********************************************************************************************************
    /// *********************************************************************************************************
    pub fn solve_sequential(&self, problem: &mut Problem) -> MrResult {
    ...
    /// **********************************************************************************************************
    /// *********************************************************************************************************
    pub fn solve_parallel_v1(&self, problem: &mut Problem) -> MrResult {
        ...
        let mut master_energy =
            match problem.energy(&master_state.clone(), self.energy_type.clone(), 0) {
                Some(nrg) => nrg,
                None => panic!("The initial configuration does not allow to calculate the energy"),
            };
        ...
        let mut temperature =
            Shared::Temperature::new(self.max_temperature, cooler, self.clone().cooling_schedule);
    ...
    /// **********************************************************************************************************
    /// *********************************************************************************************************
    pub fn solve_parallel_v2(&self, problem: &mut Problem) -> MrResult {
